...
if (process.env.NODE_ENV === "production") {
    app.use((req, res, next) => {
        ...
        if (req.path.includes("/admin/") ||
            ...
            console.log(`[DEBUG] User role: ${((_a = req.session.user) === null || _a === void 0 ? void 0 : _a.role) || "none"}`);
            console.log(`[DEBUG] User ID: ${((_b = req.session.user) === null || _b === void 0 ? void 0 : _b.id) || "none"}`);
...
app.use((req, res, next) => {
    ...
    if (req.session.user) {
        ...
        if (!req.session.serverStartTime ||
            ...
            console.log("Invalidating session due to server restart or missing serverStartTime");
