...
const getDashboard = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      `;
            ...
            console.log(`Today's kicks breakdown: Regular: ${regularKicks}, Competition: ${competitionKicks}, Custom Competition: ${customCompetitionKicks}, Total: ${stats.todayKicks}`);
        }
        catch (e) {
      ...
      `;
            ...
            console.log(`Revenue breakdown: Transactions: $${transactionRevenue}, Competition entries: $${competitionRevenue}, Competition kicks: $${competitionKickRevenue}, Custom competition kicks: $${customCompetitionKickRevenue}, Total: $${stats.totalRevenue}`);
      ...
      `;
            ...
            const nextTicket = nextTicketResult.rows.length > 0
...
const addEventLocation = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!name || !address || !startDate || !endDate) {
            req.flash("error_msg", "Name, address, start date, and end date are required");
