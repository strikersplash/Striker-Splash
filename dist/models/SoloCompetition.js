...
class SoloCompetition {
    ...
    static addParticipant(competitionId, playerId) {
        return __awaiter(this, void 0, void 0, function* () {
            const client = yield db_1.pool.connect();
            try {
      ...
      `;
                yield client.query(query, [competitionId, playerId]);
                return true;
            }
            catch (error) {
    ...
    static getParticipants(competitionId) {
        return __awaiter(this, void 0, void 0, function* () {
            const client = yield db_1.pool.connect();
            try {
                const query = `
      ...
      `;
                const result = yield client.query(query, [competitionId]);
                return result.rows;
            }
            finally {
                client.release();
    ...
    static updateParticipantKicks(competitionId, playerId, kicksUsed) {
        return __awaiter(this, void 0, void 0, function* () {
            const client = yield db_1.pool.connect();
            try {
                const query = `
      ...
      `;
                yield client.query(query, [competitionId, playerId, kicksUsed]);
                return true;
            }
            catch (error) {
    ...
    static getLeaderboard(competitionId) {
        return __awaiter(this, void 0, void 0, function* () {
            const client = yield db_1.pool.connect();
            try {
                const query = `
